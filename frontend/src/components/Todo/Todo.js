          ...
          <>
             ...
             <div className={style.modalDialog}>
               <h2 className={style.modalHeader}>
                 ...
                 <div className={style.modalDialog}>Молоко {(((milkBase[0].weight)/10)*milks[0]).toFixed(3)}</div>
                 <div className={style.modalDialog}>Сливки {(((milkBase[1].weight)/10)*milks[0]).toFixed(3)} </div>
                 <div className={style.modalDialog}>Сахар {(((milkBase[2].weight)/10)*milks[0]).toFixed(3)} </div>
                 <div className={style.modalDialog}>Декстроза {(((milkBase[3].weight)/10)*milks[0]).toFixed(3)}</div>
                 <div className={style.modalDialog}>Глюкоза {(((milkBase[4].weight)/10)*milks[0]).toFixed(3)} </div>
                 <div className={style.modalDialog}>Стабилизатор {(((milkBase[5].weight)/10)*milks[0]).toFixed(3)}</div>
                 <div className={style.modalDialog}>Улучшитель {(((milkBase[6].weight)/10)*milks[0]).toFixed(3)}</div>
                 <div className={style.modalDialog}>Сухое молоко {(((milkBase[7].weight)/10)*milks[0]).toFixed(3)}</div>
                 <button onClick={deleteMilk} className={style.modalButton}>Готово</button>
                 </div> 
                 </div> 
                 </>
         }
          ...
          <>
             ...
             <div className={style.modalDialog}>
               <h2 className={style.modalHeader}>
                 ...
                 <div className={style.modalDialog}>Вода {(((siropBase[0].weight)/10)*sirops[0]).toFixed(3)}</div>
                 <div className={style.modalDialog}>Сахар {(((siropBase[1].weight)/10)*sirops[0]).toFixed(3)} </div>
                 <div className={style.modalDialog}>Декстроза {(((siropBase[2].weight)/10)*sirops[0]).toFixed(3)} </div>
                 <div className={style.modalDialog}>Глюкоза {(((siropBase[3].weight)/10)*sirops[0]).toFixed(3)}</div>
